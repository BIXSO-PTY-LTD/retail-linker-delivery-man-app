  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: GetBuilder<OrderDetailsController>(
        builder: (orderController) {
          print('=======IIII======>>${((orderModel!.orderStatus == 'processing' || orderModel!.orderStatus == 'out_for_delivery') && !orderModel!.isPause!)}');
          print('=======Processing======>>${orderModel!.orderStatus == 'processing'}');
          print('=======OutForDelivery======>>${orderModel!.orderStatus == 'out_for_delivery'}');
          print('=======IsPause======>>${!orderModel!.isPause!}');
          print('=======Status======>>${orderModel!.orderStatus!}');

          print('=======EndOfPage======>>${Get.find<SplashController>().configModel?.imageUpload == 0}');
